...
public class DefaultRepositoryGHEventSubscriber extends GHEventsSubscriber {
    ...
    protected void onEvent(final GHSubscriberEvent event) {
        final GHEventPayload.Repository repoPayload;
        try {
            repoPayload = GitHub.offline().parseEventPayload(
        ...
        URL repoUrl = repoPayload.getRepository().getUrl();
            ...
            public void run() {
                for (Job<?, ?> job : Jenkins.getInstance().getAllItems(Job.class)) {
                    ...
                    if (trigger != null) {
                        ...
                        String userName = repoPayload.getSender().getLogin();
